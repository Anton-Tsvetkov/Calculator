...
public class CalculatorTest {
    ...
    @Test
    public void testDivisionNumberByOneIsNumber() {
        Assert.assertEquals(
    ...
    @Test
    public void testDivisionNullByNumberIsNull() {
        Assert.assertEquals(
                CALCULATOR.division(NULL, SIMPLE_TEST_NUMERIC_B), NULL);
    }

    @Test
    public void testDivisionNumberByNumberIsOne() {
        Assert.assertEquals(
    ...
    public void testDivisionNumberByZeroException() {
        try {
            ...
            Assert.assertThat(exception.getMessage(), is("Division by zero is not allowed"));
        }
    }
